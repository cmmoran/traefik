...
const resolverSuffix = ".acmeredux"
...
type VaultConfig struct {
	...
	Key         string          `description:"Vault KV key used for ACME data." json:"key,omitempty" toml:"key,omitempty" yaml:"key,omitempty"`
...
type Configuration struct {
	...
	VaultStorage         *VaultConfig `description:"Vault storage configuration." json:"vaultStorage,omitempty" toml:"vaultStorage,omitempty" yaml:"vaultStorage,omitempty" export:"true"`
...
func (p *Provider) Init() error {
	...
	if p.Configuration.VaultStorage == nil || len(p.Configuration.VaultStorage.Key) == 0 {
		return errors.New("unable to initialize ACME Redux provider without vaultStorage.key")
	}
