...
| <a id="opt-acmeRedux-certificateTimeout" href="#opt-acmeRedux-certificateTimeout" title="#opt-acmeRedux-certificateTimeout">`acmeRedux.certificateTimeout`</a> | Timeout for obtaining the certificate during the finalization request. Set this if the ACME server is slow to issue a certificate. | 30s | No |
